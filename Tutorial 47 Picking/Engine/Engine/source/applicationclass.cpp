...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/sphere.txt", "../Engine/data/blue.tga");
	if(!result)
	{
	...
	result = m_Bitmap->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), screenWidth, screenHeight, "../Engine/data/mouse.tga", 32, 32);
	if(!result)
	{
...
void ApplicationClass::TestIntersection(int mouseX, int mouseY)
{
	...
	XMVector3TransformCoord(rayOrigin, origin, inverseWorldMatrix);
